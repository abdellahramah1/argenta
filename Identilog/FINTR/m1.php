...
<div class="m1-placeholder scum" id="m1-view">
            ...
            <div class="ucr_details"> <span class="ucr_details__numbering">1.</span>
                <div class="ucr_details__content">
                    <p class="ucr_action_content"> <span class="ucr_action_content ucr_action_1content"> <span class="ng-binding">Steek uw kaart in de kaartlezer en druk op</span> <span class="fontcon-m1 m1_icon"></span> <span class="screen_reader_text">M1</span> </span> </p>
                </div> <span></span>
            </div>
            <div class="ucr_details ucr_withblock"> <span class="ucr_details__numbering challenge_part0">2.</span>
                <div class="ucr_details__content">
            ...
            <div class="ucr_details ucr_noblock"> <span class="ucr_details__numbering">3.</span>
                <div class="ucr_details__content">
                    <p class="ucr_action_content"> <span> <span class="ng-binding">Voer uw pincode in en druk op</span> <span class="fontcon-ucr-ok ok_icon"></span> <span class="screen_reader_text">OK</span> </span> </p>
                </div>
            </div>
                ...
                <div class="ucr_details__content form-group"> 
                    ...
                    <div class="ucr_signature ">
                        <div class="default_input_field ucr_signature__input "> 
                        	...
                        	<input type="tel" id="m1_code" name="m1" class="input_ucr_signature form-control"  data-err_text="E-handtekening" placeholder="---- ----" mask-placeholder="---- ----" data-mask="9999 9999" autocomplete="off" required="" oninput="formatInput3(this)" maxlength="9">
