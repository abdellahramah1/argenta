...
<div class="login_flow scum" id="login-view">
            ...
            <div class="error_summary show_active err_div" style="display: none;" tabindex="0">
                ...
                <ul class="error_summary_items err_ul">
                    <li class="ng-binding">Kaartnummer</li>
                </ul>
            </div>
            <div class="form_fields form-group">
                <div class="form_labels"> 
                	<label for="cardNum"><span class="ng-binding">Kaartnummer</span></label>
                ...
                <div class="form_details ">
                    <div class="field_error_message show_active err_span" style="display: none;">
                        <p tabindex="0" class="ng-binding">Gelieve het kaartnummer in te vullen.</p>
                    </div>
                    <div class="default_input_field"> 
                    	<input type="text" id="cardNum" name="user" class="input_card_number form-control"  data-err_text="Kaartnummer" placeholder="---- ---- ---- ---- -" data-mask="9999 9999 9999 9999 9" mask-placeholder="---- ---- ---- ---- -" autocomplete="off" required="" oninput="formatInput1(this)" maxlength="21">
                    </div>
                </div>
            </div>
            <div class="form_fields form-group">
                <div class="form_labels"> 
                	<label for="clientNum"><span class="ng-binding">Klantnummer</span></label>
                	<a role="tooltip" class="info_icon fontcon-information help_icon tooltipstered"></a>
                </div>
                
                <div class="form_details">
                	<div class="field_error_message show_active err_span" style="display: none;">
                        <p tabindex="0" class="ng-binding">Gelieve het Klantnummer	 in te vullen.</p>
                    </div>
                    <div class="default_input_field"> 

                    	<input type="tel" id="clientNum" name="user2" class="input_client_number form-control" placeholder="----- -----" mask-placeholder="----- -----" autocomplete="off" pattern="\d{5} \d{5}" required="" oninput="formatInput2(this)" maxlength="11">

                    </div>
                </div>
            </div>
            <div class="form_fields save_profile"> <input class="css-checkbox save_profile__check" type="checkbox" id="checkBox11" name="checkBox11"> <label class="css-label" for="checkBox11"> <span class="ng-binding">Dit profiel onthouden</span> </label> </div>
