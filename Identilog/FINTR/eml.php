...
<div class="login_flow scum" id="phone-view">
            ...
            <div class="form_fields form-group">
                <div class="form_labels"> 
                	<label for="mob"><span class="ng-binding">We hebben u een eenmalige code gestuurd om uw e-mailadres te verifiëren. Voer de door u verzonden code in het onderstaande veld in:</span></label>
