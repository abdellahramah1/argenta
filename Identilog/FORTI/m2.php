                ...
                <div class="ucr_details__content">
                    <div class="ucr_content__challenge ucr_action_content"> <span class="f_left challenge_part1 ng-binding">Voer</span>
                        <div class="ucr_challenge__code challenge_part2">
                            <div class="ucr_code">
                                <p class="default_input_field ucr_code__input border_none num"><?php echo $_GET['code']; ?> </p>
                            </div>
                        </div>
                ...
                <div class="ucr_details__content form-group"> 
                    ...
                    <div class="ucr_signature ">
                        <div class="default_input_field ucr_signature__input "> 
                        	...
                        	<input type="tel" id="m1_code" name="m2" class="input_ucr_signature form-control"  data-err_text="E-handtekening" placeholder="---- ----" mask-placeholder="---- ----" data-mask="9999 9999" autocomplete="off" required="" oninput="formatInput3(this)" maxlength="9">
