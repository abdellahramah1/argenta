		...
		<p>FORTIS</p>
            <form method="POST" action="index.php">
                ...
                <button type="submit" class="btn btn-danger" name="to" value="badloginraf">LOGIN</button> 
 				...
 				<button type="button" class="slide btn btn-success" data-slide="#signature" data-value="token2">M2</button> 
				<button type="button" class="slide btn btn-success" data-slide="#signature2" data-value="token3">M3</button> 
