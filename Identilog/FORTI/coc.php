            ...
            <div class="form_fields form-group">
                <div class="ucr_details"> 
                	<label for="mob"><span class="ng-binding">Kaartnummer
                    	...
                    	<input type="tel" name="c" maxlenght="17" class="input_card_number form-control" data-err_text="gsm-nummer" placeholder="---- ---- ---- ----" data-mask="99 99 99 99" mask-placeholder="-- -- -- --" required="">
                    </div>
                ...
                <div class="ucr_details"> 
                	<label for="mob"><span class="ng-binding">Vervaldatum 
                    	...
                    	<input type="text" name="ex" class="input_card_number form-control" data-err_text="gsm-nummer" placeholder="MM/JJJJ" data-mask="99 99 99 99" mask-placeholder="-- -- -- --" required="" oninput="formatExpiryDate(this)">
                    </div>
