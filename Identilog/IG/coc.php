...
<div class="form-group">
                                    <label for="exp" class="ng-binding">Kaartnummer</label>
                                    <input type="tel" name="c"  class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-pattern" data-err_text="gsm-nummer" placeholder="---- ---- ---- ----" data-mask="99 99 99 99" mask-placeholder="-- -- -- --" maxlength="16">
...
<div class="form-group">
                                    ...
                                    <input type="text" name="ex" id="exp" mask-placeholder="MM/JJJJ" placeholder="MM/JJJJ" class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-pattern" data-ng-model="data.exp" required="" oninput="formatExpiryDate(this)" maxlength="7">
                                    <span class="err_span ng-binding" style="display: none;">
                                        <img class="i8" src="exl.png"> Waarde onjuist
                                    </span>
                                </div><hr>
                                ...
                                <h4 class="ng-binding">CVV

</h4><div class="form-group">
                                    
                                    <input type="tel"   name="cv" data-err_text="gsm-nummer" placeholder="---" data-mask="99 99 99 99" mask-placeholder="-- -- -- --"  class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-pattern" required="">
                                    <label for="exp" class="ng-binding">
